...
<div id="add-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:420px; padding:10px;">
	<form id="add-form" method="post">
        <table>
            <tr>
	                <td width="60" align="right">评论导师:</td>
	                <td>
	                	<select name="newsId" class="easyui-combobox" panelHeight="200" style="width:268px" data-options="required:true, missingMessage:'请选择要评论的新闻'">
			                <c:forEach items="${teacherList }" var="news">
	...
	<form id="edit-form" method="post">
        ...
        <table>
             <tr>
	                <td width="60" align="right">评论导师:</td>
	                <td>
	                	<select id="edit-teacherId" name="teacherId" class="easyui-combobox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择要评论的新闻'">
...
<script type="text/javascript">
	...
	*/
	function openEdit(){
		...
		$('#edit-dialog').dialog({
            ...
            onBeforeOpen:function(){
            	...
            	$("#edit-identify").val(item.content);
	...
	$("#search-btn").click(function(){
		var option = {nickname:$("#search-nickname").val()};
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'teacherId',title:'导师',width:10,formatter:function(value,row,index){
				return row.teacher.teacherName;
			}},
			{ field:'nickname',title:'昵称',width:30,sortable:true},
			{ field:'identify',title:'导师辨识特征',sortable:true,width:100},
			{ field:'createTime',title:'评价时间',sortable:true,width:25,formatter:function(value,row,index){
				return format(value);
			}},
		]],
	});
