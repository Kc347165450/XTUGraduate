  ...
  <header class="article-header">
	...
	<div class="article-meta"> 
		<span class="item article-meta-time">
	  		<time class="time" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="发表时间：2019-10-14"><i class="glyphicon glyphicon-time"></i> <fmt:formatDate value="${news.createTime }" pattern="yyyy-MM-dd hh:mm:ss" /></time>
	  	</span> 
	  	<span class="item article-meta-source" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="来源：【湘大研讯】">
  ...
  <div id="respond">
		<form id="comment-form" name="comment-form" action="" method="POST">
			<div class="comment">
				...
				<input name="nickname" id="nickname" class="form-control" size="22" value="${user.nickname}" readonly="true" maxlength="15" autocomplete="off" tabindex="1" type="text">
