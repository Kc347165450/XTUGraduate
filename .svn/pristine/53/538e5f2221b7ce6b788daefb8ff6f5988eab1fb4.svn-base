...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            ...
            <label>邮箱:</label><input id="search-email" class="wu-text" style="width:100px">
            <label>所属角色:</label>
	...
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td><input type="text" name="nickname" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写昵称'" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="email" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写邮箱'"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="age" class="wu-text easyui-validatebox" /></td>
            </tr>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
            ...
            <tr>
                <td width="60" align="right">昵称:</td>
                <td><input type="text" id="edit-nickname" name="nickname" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写昵称'" /></td>
            </tr>
            <tr>
                <td width="60" align="right">所属角色:</td>
                <td>
            ...
            <tr>
                <td width="60" align="right">邮箱:</td>
                <td><input type="text" id="edit-email" name="email" value="1" class="wu-text easyui-numberbox easyui-validatebox" data-options="required:true,min:1,precision:0, missingMessage:'请填写邮箱'" /></td>
            </tr>
            <tr>
...
<script type="text/javascript">
	...
	*/
	...
	$("#search-btn").click(function(){
		...
		var option = {username:$("#search-name").val(),email:$("#search-email").val()};
		if(roleId != -1){
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'roleId',title:'所属角色',width:70,formatter:function(value,row,index){
			...
			{ field:'sex',title:'性别',width:30,formatter:function(value,row,index){
				switch(value){
					case 0:{
						return '未知';
					}
